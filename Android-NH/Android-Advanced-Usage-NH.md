...
To add the automatic banner, please refer to [Step 4, Showing Banners](Android-InApp-NH-Documentation#step4). If you do not wish to add the Automatic Banner, use one of the following options:
...
To add an automatic Interstitial Ad, please refer to [Step 5, Showing Interstitial Ads](Android-InApp-NH-Documentation#step5). 
