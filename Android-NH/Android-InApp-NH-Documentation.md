...
**If you wish to add a specific type of banner, please refer to the [Advanced Usage](Android-Advanced-Usage-NH)**.
...
User-Defined Mode      | Please refer to the [Advanced Usage](Android-Advanced-Usage-NH)
...
**If you wish to customize or use a different splash screen, please refer to the [Advanced Usage](Android-Advanced-Usage-NH).**
...
For a full integration guide, please refer to the ["Using Native Ads"](Android-Advanced-Usage-NH#using-native-ads) section under the "Advanced Usage" page.
...
##Advanced Usage
For advanced usage, please refer to the ["Advanced Usage"](Android-Advanced-Usage-NH)
