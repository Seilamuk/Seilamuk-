...
5. Click "Custom event", and fill in the following fields:  
  <img src="./iOS/images/V.png" width="12px" />  Class Name:  
  *  *STAAdMobCustomEventBanner* (for banner ads)  
  *  *STAAdMobCustomEventInterstitial* (for interstitial ads)  
  <img src="./iOS/images/V.png" width="12px" />  Label: *"StartApp Banner"* or *"StartApp Interstitial"*     
  *  *"StartApp Banner"*  (for banner ads)  
  *  *"StartApp Interstitial"*  (for interstitial ads)  
  <img src="./iOS/images/V.png" width="12px" />  Parameter: leave empty for automatic mode, or use one of the following options:    
  *  STAAdType_Overlay  
